const StackUsingLinkedListAsUnderlyingDS = require('../../../src/StackAndQueues/Assignment1/StackUsingLinkedListAsUnderlyingDS');

test('should push item into stack', () => {
    let stack = new StackUsingLinkedListAsUnderlyingDS();
